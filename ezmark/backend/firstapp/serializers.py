...
class AdminAttendanceSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        # Créer une nouvelle instance d'Assiduité avec les données validées
        attendance = Attendance.objects.create(**validated_data)
        
        # Ajouter votre logique supplémentaire ici, par exemple, envoyer une notification
        subject = "Nouvelle entrée d'assiduité"
        message = "Une nouvelle entrée d'assiduité a été enregistrée."
    ...
    def update(self, instance, validated_data):
        # Mettre à jour l'instance d'Assiduité avec les données validées
        instance.date = validated_data.get('date', instance.date)
        instance.status = validated_data.get('status', instance.status)
        instance.save()
        
        # Ajouter votre logique supplémentaire ici, par exemple, envoyer une notification
        subject = "Mise à jour de l'assiduité"
        message = "Une entrée d'assiduité a été mise à jour."
        recipient_list = ['destinataire@example.com']
        send_notification_email.delay(subject, message, recipient_list)
