...
from .views import (
    ...
    AdminloginView,   
    PendingRequestView,
    AdminMarkAttendanceViews, 
    AdminMarkAttendanceAPIView,
...
urlpatterns = [
    ...
    path('update/geofence/',UpdateGeofenceView.as_view(), name = "update_geofence") ,
    path('mark-attendances/', AdminMarkAttendanceViews.as_view(), name='admin_mark_attendance_views'),
    path('mark-attendance/', AdminMarkAttendanceAPIView.as_view(), name='admin_mark_attendance_api'), #19
]
